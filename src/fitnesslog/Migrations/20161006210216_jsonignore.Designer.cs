...
namespace FitnessLog.Migrations
{
    ...
    [Migration("20161006210216_jsonignore")]
    partial class jsonignore
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("FitnessLog.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("FitnessLog.Models.Entry", b =>
                {
                    b.HasOne("FitnessLog.Models.ApplicationUser", "User")
                        .WithMany("Log")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FitnessLog.Models.ApplicationUser")
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
